...
const haha = new Promise((resolve, reject) => setTimeout(reject, 2000, "Reject"));

const ahhh = new Promise((reject, resolve) => setTimeout(resolve, 7000, "Resolve"));
...
const promise2 = new Promise ((resolve, reject) =>{
        return setTimeout(() => resolve("Thank you Creator for giving me another chance to develop my life. On God!"), 3000)
});
...
const promise3 = new Promise((resolve, reject) =>
        resolve("BUggati Chiron Super Sport")
);
